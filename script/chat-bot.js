...
for (let i = 0; i < coll.length; i++) {
  coll[i].addEventListener("click", function () {
    ...
    if (content.style.width === "300px") {
      // coll[i].removeChild("title");
      // text.classList.toggle("chat-title");
      // text.remove();
      content.style.width = "0px";
      coll[i].style.width = "6rem";
    } else {
      // text.classList.toggle("chat-title");
      // text.innerHTML = "Задайте нам вопрос !";
      // coll[i].appendChild(text);
      content.style.width = "300px";
      coll[i].style.width = "300px";
    }
...
function heartButton() {
  buttonSendText("Мне нравится работа вашего чат-бота !");
}
